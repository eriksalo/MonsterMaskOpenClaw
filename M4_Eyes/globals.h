...
// Mood reload system
GLOBAL_VAR volatile bool reloadRequested   GLOBAL_INIT(false);
GLOBAL_VAR char          reloadConfigPath[64];
extern void              reloadEyeConfig(const char *configPath);
extern void              initReloadState(void);
